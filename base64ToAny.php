...
class Base64ToAny{
	...
	function base64_to_jpeg($base64_string, $fileName) {
		$dir = date("M-Y-d");
		if (!file_exists('/var/www/trinityapplab.in/html/MealsFly/files/'.$dir)) {
		    mkdir('/var/www/trinityapplab.in/html/MealsFly/files/'.$dir, 0777, true);
		}

		$folderPath = "/var/www/trinityapplab.in/html/MealsFly/files/".$dir."/";
		$imageURL = "https://www.trinityapplab.in/MealsFly/files/".$dir."/";
